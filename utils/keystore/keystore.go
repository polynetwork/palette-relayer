...
type PaletteKeyStore struct {
	keyStore *keystore.KeyStore
	chainId  *big.Int
}

func NewPaletteKeyStore(keystorePath string,
	chainId *big.Int) (*PaletteKeyStore, error) {

	service := &PaletteKeyStore{
		chainId: chainId,
...
func (s *PaletteKeyStore) UnlockKeys(pwds map[string]string) error {
...
func (s *PaletteKeyStore) SignTransaction(
...
func (s *PaletteKeyStore) GetAccounts() []accounts.Account {
	return s.keyStore.Accounts()
}

func (s *PaletteKeyStore) GetChainId() uint64 {
